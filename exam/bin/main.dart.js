...
(function dartProgram() {
  ...
  A = {JS_CONST: function JS_CONST() {
    ...
    main() {
      ...
      t1 = t1.querySelector("#btnSearch");
      if (t1 != null) {
        t1 = J.get$onClick$x(t1);
        t2 = t1.$ti;
        A._EventStreamSubscription$(t1._target, t1._eventType, t2._eval$1("~(1)?")._as(new A.main_closure1()), false, t2._precomputed1);
      }
      A.displayOrders($.orders);
    },
    displayOrders(orderList) {
      var t2, t3, t4, _i, o, row, t5, t6, t7, t8, t9,
        t1 = document,
        tableBody = type$.TableSectionElement._as(t1.querySelector("#orderBody"));
      tableBody.children.toString;
      B.TableSectionElement_methods._clearChildren$0(tableBody);
      for (t2 = orderList.length, t3 = type$.JSArray_Element, t4 = type$.Iterable_Element, _i = 0; _i < orderList.length; orderList.length === t2 || (0, A.throwConcurrentModificationError)(orderList), ++_i) {
        o = orderList[_i];
        row = t1.createElement("tr");
        row.children.toString;
        t5 = t1.createElement("td");
        t5.toString;
        B.TableCellElement_methods.set$text(t5, o.item);
        t6 = t1.createElement("td");
        t6.toString;
        B.TableCellElement_methods.set$text(t6, o.itemName);
        t7 = t1.createElement("td");
        t7.toString;
        B.TableCellElement_methods.set$text(t7, B.JSNumber_methods.toString$0(o.price));
        t8 = t1.createElement("td");
        t8.toString;
        B.TableCellElement_methods.set$text(t8, o.currency);
        t9 = t1.createElement("td");
        t9.toString;
        B.TableCellElement_methods.set$text(t9, B.JSInt_methods.toString$0(o.quantity));
        A._ChildrenElementList__addAll(row, t4._as(A._setArrayType([t5, t6, t7, t8, t9], t3)));
        tableBody.appendChild(row).toString;
      }
    },
    addOrder() {
      var item, itemName, price, currency, quantity,
        t1 = document,
        t2 = type$.InputElement,
        t3 = t2._as(t1.querySelector("#item")).value;
      t3.toString;
      item = B.JSString_methods.trim$0(t3);
      t3 = t2._as(t1.querySelector("#itemName")).value;
      t3.toString;
      itemName = B.JSString_methods.trim$0(t3);
      t3 = t2._as(t1.querySelector("#price")).value;
      t3.toString;
      price = A.Primitives_parseDouble(t3);
      if (price == null)
        price = 0;
      t3 = t2._as(t1.querySelector("#currency")).value;
      t3.toString;
      currency = B.JSString_methods.trim$0(t3);
      t1 = t2._as(t1.querySelector("#quantity")).value;
      t1.toString;
      quantity = A.Primitives_parseInt(t1, null);
      if (quantity == null)
        quantity = 1;
      if (item.length === 0 || itemName.length === 0) {
        t1 = window;
        t1.toString;
        B.Window_methods.alert$1(t1, "Please fill all required fields!");
        return;
      }
      B.JSArray_methods.add$1($.orders, new A.Order(item, itemName, price, currency, quantity));
      A.displayOrders($.orders);
      t1 = window;
      t1.toString;
      B.Window_methods.alert$1(t1, "\u2705 Order added successfully!");
    },
    searchOrder() {
      var keyword, t2, t3, filtered,
        t1 = type$.InputElement._as(document.querySelector("#searchBox")).value;
      t1.toString;
      keyword = B.JSString_methods.trim$0(t1).toLowerCase();
      if (keyword.length === 0) {
        A.displayOrders($.orders);
        return;
      }
      ...
      filtered = A.List_List$_of(new A.WhereIterable(t1, t2._eval$1("bool(1)")._as(new A.searchOrder_closure(keyword)), t3), t3._eval$1("Iterable.E"));
      A.displayOrders(filtered);
    },
    ...
    searchOrder_closure: function searchOrder_closure(t0) {
      this.keyword = t0;
    },
  ...
  A.main_closure.prototype = {
    call$1(e) {
      ...
      return new A.Order(A._asString(e.$index(0, "Item")), A._asString(e.$index(0, "ItemName")), A._asNum(e.$index(0, "Price")), A._asString(e.$index(0, "Currency")), A._asInt(e.$index(0, "Quantity")));
    },
    $signature: 12
  };
  ...
  A.searchOrder_closure.prototype = {
    call$1(o) {
      type$.Order._as(o);
      return A.stringContainsUnchecked(o.itemName.toLowerCase(), this.keyword, 0);
    },
    $signature: 13
  };
  (function aliases() {
  ...
  (function inheritance() {
    ...
    _inheritMany(A.Closure, [A.Closure0Args, A.Closure2Args, A.TearOffClosure, A.initHooks_closure, A.initHooks_closure1, A._AsyncRun__initializeScheduleImmediate_internalCallback, A._AsyncRun__initializeScheduleImmediate_closure, A._Future__propagateToListeners_handleWhenCompleteCallback_closure, A.Stream_length_closure, A._RootZone_bindUnaryCallbackGuarded_closure, A._EventStreamSubscription_closure, A.main_closure, A.main_closure0, A.main_closure1, A.searchOrder_closure]);
    ...
    _inheritMany(A.HtmlElement, [A.AnchorElement, A.AreaElement, A.FormElement, A.InputElement, A.SelectElement, A.TableCellElement, A.TableSectionElement]);
...
;
  ...
  (function staticFields() {
    ...
    $.orders = A._setArrayType([], A.findType("JSArray<Order>"));
  })();
